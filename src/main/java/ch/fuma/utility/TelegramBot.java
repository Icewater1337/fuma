...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public void send(EventForm eventForm) {
        ...
        try {
            ...
            String link = "http://www.google.com/calendar/event?action=TEMPLATE&src=qfq3qv4m3jgefoeeb0imp530q4@group.calendar.google.com&text=" + eventForm.getDescription() + "&dates=" + startDate + "/" + endDate + "&details=&sprop=&location=";

            SendMessage message = new SendMessage() // Create a SendMessage object with mandatory fields
                .setChatId(chatId)
                .setText("Hey, the person with the ip: " + eventForm.getIpAddress() + " sent you the following proposal: " + eventForm.getDescription() + "\n the link is: \n" + link);
